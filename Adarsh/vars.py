...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN','6884496947:AAF2Oc__MoO-foKmUYia0kCwQai0-cSBWcA'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '10.134.220.200:8080')) if not ON_HEROKU or getenv('FQDN', '10.134.220.200:8080') else APP_NAME+'.herokuapp.com'
